...
function OnvifServicePtz(params) {
	...
	if('xaddr' in params) {
		if(err_msg = helpers.isInvalidValue(params['xaddr'], 'string')) {
	...
	if('user' in params) {
		if(err_msg = helpers.isInvalidValue(params['user'], 'string', true)) {
	...
	if('pass' in params) {
		if(err_msg = helpers.isInvalidValue(params['pass'], 'string', true)) {
	...
	this.time_diff = params['timeDifference'];
...
OnvifServicePtz.prototype.getNode = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['NodeToken'], 'string')) {
...
OnvifServicePtz.prototype.continuousMove = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['Velocity'], 'object')) {
		...
		for(let i=0; i<klist.length; i++) {
			...
			if(err_msg = helpers.isInvalidValue(v, 'float')) {
		...
		if('Timeout' in params) {
			if(err_msg = helpers.isInvalidValue(params['Timeout'], 'integer')) {
...
OnvifServicePtz.prototype.absoluteMove = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['Position'], 'object')) {
		...
		if('Speed' in params) {
			if(err_msg = helpers.isInvalidValue(params['Speed'], 'object')) {
...
OnvifServicePtz.prototype.relativeMove = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['Translation'], 'object')) {
...
OnvifServicePtz.prototype.stop = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if('PanTilt' in params) {
			if(err_msg = helpers.isInvalidValue(params['PanTilt'], 'boolean')) {
		...
		if('Zoom' in params) {
			if(err_msg = helpers.isInvalidValue(params['Zoom'], 'boolean')) {
...
OnvifServicePtz.prototype.gotoHomePosition = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if('Speed' in params) {
			if(err_msg = helpers.isInvalidValue(params['Speed'], 'float')) {
				reject(new Error('The "Speed" property was invalid: ' + err_msg));
				return;
			}
		}
...
OnvifServicePtz.prototype.setPreset = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if('PresetToken' in params) {
			if(err_msg = helpers.isInvalidValue(params['PresetToken'], 'string')) {
		...
		if('PresetName' in params) {
			if(err_msg = helpers.isInvalidValue(params['PresetName'], 'string')) {
