...
OnvifServiceMedia.prototype.setVideoEncoderConfiguration = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		try {
			...
			soap_body +=   '<Configuration token="' + params['ConfigurationToken'] + '">';
			soap_body +=   		'<Name>' + params.Configuration.Name + '</Name>';
			soap_body +=   		'<UseCount xmlns="http://www.onvif.org/ver10/schema">' + params.Configuration.UseCount + '</UseCount>';
			soap_body +=   		'<Encoding xmlns="http://www.onvif.org/ver10/schema">' + params.Configuration.Encoding + '</Encoding>';
			soap_body +=   		'<Resolution xmlns="http://www.onvif.org/ver10/schema">';
			...
			soap_body +=   		'</Resolution>';
			soap_body +=   		'<Quality xmlns="http://www.onvif.org/ver10/schema">' + params.Configuration.Quality + '</Quality>';
        
            if (params.Configuration.RateControl) {
                soap_body +=   	'<RateControl xmlns="http://www.onvif.org/ver10/schema">';
                soap_body +=   		'<FrameRateLimit>' + params.Configuration.RateControl.FrameRateLimit + '</FrameRateLimit>';
                soap_body +=   		'<EncodingInterval>' + params.Configuration.RateControl.EncodingInterval + '</EncodingInterval>';
                soap_body +=   		'<BitrateLimit>'  + params.Configuration.RateControl.BitrateLimit + '</BitrateLimit>';
                soap_body +=   	'</RateControl>';
            }
    
            if (params.Configuration.H264) {
                soap_body +=    '<H264 xmlns="http://www.onvif.org/ver10/schema">';
                soap_body +=   	    '<GovLength>' + params.Configuration.H264.GovLength + '</GovLength>';
                soap_body +=   	    '<H264Profile>' + params.Configuration.H264.H264Profile + '</H264Profile>';
                soap_body +=   	'</H264>';
            }

            if (params.Configuration.MPEG4) {
                soap_body +=    '<MPEG4 xmlns="http://www.onvif.org/ver10/schema">';
                soap_body +=   	    '<GovLength>' + params.Configuration.MPEG4.GovLength + '</GovLength>';
                soap_body +=   	    '<Mpeg4Profile>' + params.Configuration.MPEG4.H264Profile + '</Mpeg4Profile>';
                soap_body +=   	'</MPEG4>';
            }

			soap_body +=   		'<Multicast xmlns="http://www.onvif.org/ver10/schema">';
			soap_body +=   			'<Address>';
			soap_body +=   				'<Type>'+ params.Configuration.Multicast.Address.Type + '</Type>';
            if (params.Configuration.Multicast.Address.IPv4Address) {
                soap_body +=   			'<IPv4Address>' + params.Configuration.Multicast.Address.IPv4Address + '</IPv4Address>';
            }
            if (params.Configuration.Multicast.Address.IPv6Address) {
                soap_body +=   			'<IPv6Address>' + params.Configuration.Multicast.Address.IPv6Address + '</IPv6Address>';
            }
			soap_body +=   			'</Address>';
			...
			soap_body +=   		'</Multicast>';
			soap_body +=   		'<SessionTimeout xmlns="http://www.onvif.org/ver10/schema">' + params.Configuration.SessionTimeout + '</SessionTimeout>';
