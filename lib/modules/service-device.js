...
OnvifServiceDevice.prototype.setScopes = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(scope_list, 'array', true)) {
...
OnvifServiceDevice.prototype.removeScopes = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let scope_list = params['Scopes'];
		if(err_msg = helpers.isInvalidValue(scope_list, 'array')) {
			reject(new Error('The "Scopes" property was invalid: ' + err_msg));
			return;
		}
...
OnvifServiceDevice.prototype.setHostname = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(hostname, 'string')) {
...
OnvifServiceDevice.prototype.setDNS = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if('DNSManual' in params) {
			if(err_msg = helpers.isInvalidValue(params['DNSManual'], 'array', true)) {
			...
			for(let i=0; i<params['DNSManual'].length; i++) {
				...
				if(err_msg = helpers.isInvalidValue(o, 'object')) {
					reject(new Error('The "DNSManual" property was invalid: ' + err_msg));
					return;
				}

				let type = o['Type'];
				if(err_msg = helpers.isInvalidValue(type, 'string')) {
				...
				if(type === 'IPv4') {
					if(err_msg = helpers.isInvalidValue(o['IPv4Address'], 'string')) {
						reject(new Error('The "IPv4Address" property was invalid: ' + err_msg));
						return;
					}
				} else if(type === 'IPv6') {
					if(err_msg = helpers.isInvalidValue(o['IPv6Address'], 'string')) {
...
OnvifServiceDevice.prototype.setNetworkProtocols = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['NetworkProtocols'], 'array', true)) {
		...
		for(let i=0; i<params['NetworkProtocols'].length; i++) {
			...
			if(err_msg = helpers.isInvalidValue(o['Name'], 'string')) {
			...
			if('Enabled' in o) {
				if(err_msg = helpers.isInvalidValue(o['Enabled'], 'boolean')) {
			...
			if('Port' in o) {
				if(err_msg = helpers.isInvalidValue(o['Port'], 'integer')) {
...
OnvifServiceDevice.prototype.setNetworkDefaultGateway = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['NetworkGateway'], 'array', true)) {
...
OnvifServiceDevice.prototype.setSystemDateAndTime = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['DateTimeType'], 'string')) {
		...
		if(err_msg = helpers.isInvalidValue(params['DaylightSavings'], 'boolean')) {
			reject(new Error('The "DaylightSavings" property was invalid: ' + err_msg));
			return;
		}
	
		if('TimeZone' in params) {
			if(err_msg = helpers.isInvalidValue(params['TimeZone'], 'string')) {
...
OnvifServiceDevice.prototype.createUsers = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['User'], 'array')) {
		...
		for(let i=0; i<params['User'].length; i++) {
			let u = params['User'][i];
			if(err_msg = helpers.isInvalidValue(u, 'object')) {
				reject(new Error('The "User" property was invalid: ' + err_msg));
				return;
			}
	
			if(err_msg = helpers.isInvalidValue(u['Username'], 'string')) {
				reject(new Error('The "Username" property was invalid: ' + err_msg));
				return;
			}
	
			if(err_msg = helpers.isInvalidValue(u['Password'], 'string')) {
				reject(new Error('The "Password" property was invalid: ' + err_msg));
				return;
			}
	
			if(err_msg = helpers.isInvalidValue(u['UserLevel'], 'string')) {
...
OnvifServiceDevice.prototype.setNTP = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if('NTPManual' in params) {
			if(err_msg = helpers.isInvalidValue(params['NTPManual'], 'object')) {
...
OnvifServiceDevice.prototype.setIPAddressFilter = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['Type'], 'string')) {
			reject(new Error('The "Type" property was invalid: ' + err_msg));
			return;
		...
		if(err_msg = helpers.isInvalidValue(params['IPv4Address'], 'array')) {
			reject(new Error('The "IPv4Address" property was invalid: ' + err_msg));
			return;
		}
		...
		for(let i=0; i<params['IPv4Address'].length; i++) {
			...
			if(err_msg = helpers.isInvalidValue(o['Address'], 'string')) {
			...
			if(err_msg = helpers.isInvalidValue(o['PrefixLength'], 'integer')) {
...
OnvifServiceDevice.prototype.getServices = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		if(err_msg = helpers.isInvalidValue(params['IncludeCapability'], 'boolean')) {
